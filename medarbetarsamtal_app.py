...
st.markdown("""
<style>
    /* Global App Background - Dark artistic gradient with lines/glow */
    .stApp {
        background: radial-gradient(circle at 20% 20%, rgba(30, 58, 138, 0.4) 0%, transparent 40%),
    ...
    /* SIDEBAR INPUT FIELDS - BLACK TEXT ON WHITE BACKGROUND (HIGH CONTRAST) */
    ...
    /* Main Area Input Fields & Textareas */
